  ...
  return (
    <>
      <SEO
        title={
          language === "ar"
            ? "BeePro Academy | تواصل معنا"
            : "BeePro Academy | Contact Us"
        }
        description={
          language === "ar"
            ? "تواصل مع فريق BeePro Academy للحصول على استشارات حول الدورات، الدعم التعليمي، وأسئلة التسجيل."
            : "Contact BeePro Academy for course guidance, learning support, or enrollment questions."
        }
        ...
        <section className="py-16">
          <div className="bepro-container">
            <div className="bepro-page-header">
              ...
              <p>{t("contact.haveQuestionsAboutOurCoursesPr")}</p>
            </div>
          </div>
        </section>
