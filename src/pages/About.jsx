  ...
  return (
    <>
      <SEO
        title={
          language === "ar"
            ? "BeePro Academy | من نحن"
            : "BeePro Academy | About Us"
        }
        description={
          language === "ar"
            ? "تعرف على فريق BeePro Academy ورؤيتنا ورسالتنا التعليمية في بناء خبراء في البرمجة وتحليل الأسواق المالية."
            : "Learn about BeePro Academy's team, vision, and mission to empower learners in programming and financial markets."
        }
      ...
      <div className="bepro-page">
        <section className="py-20">
          <div className="bepro-container">
            <div className="bepro-page-header">
              ...
              <p>{t("about.beeproAcademyIsALeadingEducati")}</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="bepro-container">
            <div className="bepro-grid-2">
              ...
              <div
                className="bepro-card animate-fadeInUp"
        ...
        <section className="py-16">
          <div className="bepro-container">
            <h2 className="bepro-section-title">{t("about.ourValues")}</h2>
            <div className="bepro-grid-4 mt-12">
              {values.map((value, index) => (
                <div
                  key={index}
                  className="bepro-card text-center animate-fadeInUp"
        ...
        <section className="py-16 pb-20">
          <div className="bepro-container">
            <h2 className="bepro-section-title">{t("about.ourTeam")}</h2>
            ...
            <div className="bepro-grid-3 mt-12">
              {teamMembers.map((member, index) => (
                ...
                >
                  ...
                  <p className="text-[#00D9FF] font-medium mb-2">
                    {member.title}
                  </p>
